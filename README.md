...
## **Ссылки на свёрстанные экраны**
    http://localhost:3000/ - домашний экран
    http://localhost:3000/500 - экран ошибки
    http://localhost:3000/404 - экран 404 ошибки(либо любой неизвестный путь)
    http://localhost:3000/sign-in - экран авторизации
    http://localhost:3000/sign-up - экран регистрации
